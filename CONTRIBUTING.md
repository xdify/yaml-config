...
**Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests.** You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/xaify) where the questions should be tagged with tag `xaify`.
...
You can file new issues by filling out our [new issue form](https://github.com/xaify/yaml-config/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

1. Search [GitHub](https://github.com/xdify/yaml-config/pulls) for an open or closed PR
  that relates to your submission. You don't want to duplicate effort.
<!-- 1. Please sign our [Contributor License Agreement (CLA)](#cla) before sending PRs.
  We cannot accept code without this. -->
1. Fork the xdify/yaml-config repo.
...
1. In GitHub, send a pull request to `xaify:main`.
...
```
```
fix(@xaify/core) need to depend on latest rxjs and zone.js
